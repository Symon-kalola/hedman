                ...
                <div class="row row-cols-1 row-cols-md-3 g-4 text-center my-auto ">
                    ...
                    <div class="col " >
                        ...
                        <div class="card-body"  style="margin-top: -50px;">
                            ...
                            <p class="card-text">We provide cheep labour for planting  seedlings, making firebreaks & prunning</p>
                        </div>
                        </div>
                    </div>
...
<div class=" shadow-sm " style="margin-top: -45px;"> 
     ...
     <div class="  bg-success py-1 shadow-sm  text-center  " style="opacity: 0.8;" ><h4 class=" text-white mt-1 "  ><b>AVAILABLE PRODUCTS</b></h4></div>
    <div class="row pt-2 shadow-sm"  style=" " >
    ...
    {{-- beginning of the service section --}}
         <div class="  bg-success py-1 shadow-sm  text-center  "  ><h4 class=" text-white mt-1 "  ><b>SERVICES WE PROVIDE</b></h4></div>
         @include('userComponents.homeServices')
    {{-- end of the service section --}}
    {{-- the feedback section start --}}
             <div class="  bg-success py-1 shadow-sm mt-2  text-center  "  ><h4 class=" text-white mt-1 "  ><b>CUSTOMERS FEEDBACK MESSAGES</b></h4></div>
