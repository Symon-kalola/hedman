    ...
    <div id="app ">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container-fluid">
                <a class="navbar-brand logo text-success" href="#"><img
                        style="height:30px;width:auto; font-weight:bolder;" src="/images/icon.png"
                        class="mx-2 image-fluid rounded-circle" alt="..">HEDMAN</a>
                    ...
                    <div class="row  text-white ">
                            ...
                            <div class=" form-outline text-white">
                                <form method="POST" action="/feedback/store">
                                    ...
                                    <input type="text" class="form-control form-control-sm text-success "
                                        name="name" id="place" placeholder="name">

                            </div>
                            <div class="form-outline text-white">
                                <label for="" class="form-label text-white">Your Message</label>
                                <textarea name="feedback" class="form-control bg-success text-white border-white" id="feedback" cols="30"
                                    rows="4" style="background:transparent;"></textarea>
                            </div>
                        ...
                        <div class="col-sm-4 footer-col text-white">
                            ...
                            <p id="num">0998672577 <br>
                                088 2751 360 <br>
                                099 1491 663 <br>
                                <a href="https://wa.me/265882751360"><span
                                        class="fab fa-whatsapp themec mx-1 "></span>Chat on whatsapp</a>
                                <a href="https://facebook.com/groups/689169124490599/"><span
                                        class="fab fa-facebook mx-1  "
                                        style="color: rgba(18, 132, 224, 0.877)"></span>facebook</a>

                                <br>
                                <a href="mailto:nyirendasymon124@gmail.com " class="fa fa-envelope"> Send email</a>

                            </p>
                            <P class="small">Or visit our offices located in Gwamba bulding behind <br>Northen region
                                Water board Kawiluwilu house in Mzuzu</P>
